...
const worlds: WorldCard[] = [
  {
    ...
    description:
      "Quản lý và lưu trữ tài liệu với khả năng tìm kiếm AI và đồng bộ Google Drive realtime.",
  ...
  },
  {
    ...
    subtitle: "Code & Notes",
    description:
      "Lưu trữ văn bản, code snippets và ghi chú với syntax highlighting tự động.",
  ...
  },
  {
    ...
    description:
      "Khu vực đang được phát triển. Tính năng mới sẽ sớm được cập nhật.",
  ...
  return (
    <>
      ...
      <TechLayout showGrid={false} accentColor="#00ff88">
        {/* Matrix-style Background - MagneticPixels */}
        <div className="fixed inset-0 z-0">
          ...
          />
          {/* Vignette overlay */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.5)_70%,black_100%)]" />
          {/* Scanlines */}
          <div
            ...
            {worlds.map((world, index) => (
              ...
              >
                <div className="max-w-lg w-full">
                  ...
                  <VoidZone
                    active={world.status === "coming_soon"}
                    intensity="medium"
                  >
                    <div
                    ...
                    >
                      ...
                      <div className="flex justify-center mb-6">
                        <div className="relative">
                          <PulseRing
                            color={world.color}
                            size={100}
                            rings={world.status === "available" ? 3 : 0}
                            speed={3}
                          />
                          <div
                      ...
                      <div className="absolute top-3 right-3">
                        <TechBadge
                          variant={
                            world.status === "available" ? "success" : "warning"
                          }
                          size="sm"
                  ...
                  <div className="text-center mt-6">
                    <span className="text-xs font-mono text-muted-foreground">
                      WORLD_{String(index + 1).padStart(2, "0")} /{" "}
